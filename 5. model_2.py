...
immatrix = array([array(io.imread(path1+ '//' + im1).reshape(1,31,31))
             for im1 in sorted(imlist)],'f')
...
model.add(Convolution2D(256, (3, 3), padding='same', input_shape=(1,31,31))) #Try for 25x25 patch
...
"""
model.add(Convolution2D(64, kernel_size=(3, 3), padding="same",strides=(1, 1), data_format='channels_first', input_shape = (1, 31, 31), kernel_initializer = 'glorot_normal', bias_initializer=constant(0.1) ))
model.add(LeakyReLU(alpha=0.333))
model.add(Convolution2D(64, kernel_size=(3, 3), padding="same",strides=(1, 1), data_format='channels_first', input_shape = (64, 33, 33), kernel_initializer = 'glorot_normal', bias_initializer=constant(0.1) ))
model.add(LeakyReLU(alpha=0.333))
model.add(Convolution2D(64, kernel_size=(3, 3), padding="same",strides=(1, 1), data_format='channels_first', input_shape = (64, 33, 33), kernel_initializer = 'glorot_normal', bias_initializer=constant(0.1) ))
model.add(LeakyReLU(alpha=0.333))
...
model.add(Convolution2D(128, kernel_size=(3, 3), padding="same",strides=(1, 1), data_format='channels_first', input_shape = (64, 16, 16), kernel_initializer = 'glorot_normal', bias_initializer=constant(0.1) ))
model.add(LeakyReLU(alpha=0.333))
model.add(Convolution2D(128, kernel_size=(3, 3), padding="same",strides=(1, 1), data_format='channels_first', input_shape = (128, 16, 16), kernel_initializer = 'glorot_normal', bias_initializer=constant(0.1) ))
model.add(LeakyReLU(alpha=0.333))
model.add(Convolution2D(128, kernel_size=(3, 3), padding="same",strides=(1, 1), data_format='channels_first', input_shape = (128, 16, 16), kernel_initializer = 'glorot_normal', bias_initializer=constant(0.1) ))
model.add(LeakyReLU(alpha = 0.333))
model.add(MaxPooling2D(pool_size=(3, 3), strides=(2, 2)))
...
model.add(Dropout(0.5))
        ...
        # FC => SOFTMAX
model.add(Dense(5, kernel_initializer = 'glorot_normal', bias_initializer = constant(0.1)))
model.add(Activation("softmax"))
"""
opt = SGD(lr=0.1)
